...
module.exports = [
  ...
  },
  {
    ...
    async run() {
              ...
              options: [
                {
                  ...
                  effects: {
                    ...
                    obstacles: { selection_confusion: -2, writing_friction: 0, time_pressure: 0 }
                  }
                },
                {
                  value: "somewhat",
                ...
                },
                {
                  ...
                  effects: {
                    ...
                    obstacles: { selection_confusion: 4, writing_friction: 0, time_pressure: 0 }
                  }
                }
              ]
            },
              ...
              options: [
                {
                  ...
                  effects: {
                    ...
                    obstacles: { selection_confusion: 0, writing_friction: -2, time_pressure: 0 }
                  }
                },
                {
                  value: "medium",
                ...
                },
                {
                  ...
                  effects: {
                    ...
                    obstacles: { selection_confusion: 0, writing_friction: 4, time_pressure: 0 }
                  }
                }
              ]
            },
              ...
              options: [
                {
                  ...
                  effects: {
                    ...
                    obstacles: { selection_confusion: 0, writing_friction: 0, time_pressure: -2 }
                  }
                },
                {
                  value: "some",
                ...
                },
                {
                  ...
                  effects: {
                    ...
                    obstacles: { selection_confusion: 0, writing_friction: 0, time_pressure: 4 }
                  }
                }
              ]
            },
              ...
              options: [
                {
                  ...
                  effects: {
                    ...
                    obstacles: { selection_confusion: 0, writing_friction: 0, time_pressure: 0 }
                  }
                },
                {
                  value: "limited",
      ...
      const curation = suggestion.profile.positiveFactors.find(
        (factor) => factor.key === "curation_clarity"
      );
      const writing = suggestion.profile.positiveFactors.find(
        (factor) => factor.key === "storytelling"
      );
      const writingFriction = suggestion.profile.constraints.find(
        (constraint) => constraint.key === "writing_friction"
      );
  ...
  },
  {
    ...
    async run() {
      ...
      try {
        await buildSuggestedProfile({
          goal: {
            ...
            label: "Finish my portfolio",
            description:
              "Organize and complete a portfolio that clearly shows your strongest work.",
            questions: [
              {
                key: "project_selection",
                prompt: "How clear are you on which projects belong in the portfolio?",
      ...
      assert.ok(
        /Ollama could not complete the resource suggestion step/i.test(capturedError.message)
      );
    }
  }
];
